    ...
    return {
        ...
        "lane_range": {
            ...
            "presets": [
                {
                    "count": 4,
                    "label": "Simple (4 lanes)",
                    "description": "Kick, Snare, Hi-hat, Crash",
                },
                {
                    "count": 5,
                    "label": "Standard (5 lanes)",
                    "description": "Basic kit with toms",
                },
                {
                    "count": 7,
                    "label": "Full (7 lanes)",
                ...
                {
                    "count": 8,
                    "label": "Extended (8 lanes)",
                    "description": "Full kit + extras",
                },
            ],
        },
    }
