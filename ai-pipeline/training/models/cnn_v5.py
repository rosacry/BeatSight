...
class DrumClassifierCNNv5(nn.Module):
    ...
    Args:
        num_classes: Number of drum classes (default 12, base model classes from
                     components.json after rimshot merge into snare)
...
if __name__ == "__main__":
    ...
    # Test basic forward (12 classes - base model with rimshot merged into snare)
    model = DrumClassifierCNNv5(
        num_classes=12,
        use_deep_supervision=True,
        use_multi_task=True,
    ...
    # Test loss
    criterion = V5Loss()
    targets = torch.randint(0, 12, (4,))  # 12 classes
