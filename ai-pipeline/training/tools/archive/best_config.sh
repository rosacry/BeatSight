#!/bin/bash
# =============================================================================
# BEST CONFIG - Maximum Validation Accuracy
# =============================================================================
# Based on all testing:
#   V7: 54.27% (best) - uniform sampling, no focal, lr 0.0001, batch 1024
#   V8: 53.88% - class-balanced loss didn't help
#
# This config: V7 formula + more data + more epochs
# =============================================================================
...
RUN_DIR="${BEATSIGHT_REPO_ROOT}/ai-pipeline/training/runs/best_config_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$RUN_DIR"

echo "========================================================================"
echo "  BEST CONFIG - Maximum Validation Accuracy"
echo "========================================================================"
echo "Output: $RUN_DIR"
echo ""
