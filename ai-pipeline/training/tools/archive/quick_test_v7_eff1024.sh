#!/bin/bash
# =============================================================================
# Quick Test V7 - v6 config + grad accumulation (effective batch 1024)
# =============================================================================
# v6 WORKED (59.24% balanced acc with batch 256)
# Testing if effective batch 1024 (like original v2a) causes collapse
# =============================================================================
...
RUN_DIR="${BEATSIGHT_REPO_ROOT}/ai-pipeline/training/runs/config_test_v7_eff1024_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$RUN_DIR"

echo "========================================================================"
echo "  V7 - v6 config + grad-accum 4 (effective batch 1024)"
echo "========================================================================"
echo "Output: $RUN_DIR"
echo ""
echo "Base config from v6 (which worked at 59.24%):"
...
echo ""
echo "ONLY CHANGE: grad-accum-steps 4 (effective batch 1024)"
echo "This matches the original v2a effective batch size!"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo ""
echo "If this works, effective batch 1024 is NOT the issue."
echo "If it collapses, large effective batch + uniform sampling is the problem."
echo ""
