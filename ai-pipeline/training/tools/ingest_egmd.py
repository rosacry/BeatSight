...
# IMPORTANT: E-GMD uses Roland TD-11 mapping (same as Groove MIDI Dataset), NOT General MIDI!
# Reference: https://magenta.tensorflow.org/datasets/e-gmd
# Reference: https://github.com/magenta/magenta/blob/main/magenta/models/onsets_frames_transcription/drum_mappings.py
NOTE_MAP: Dict[int, Tuple[str, Dict[str, str]]] = {
    ...
    37: ("cross_stick", {}),
    # Toms (Roland TD-11: 48/50=Tom1, 45/47=Tom2, 43/58=Tom3)
    48: ("tom_high", {}),
    50: ("tom_high", {"strike_position": "rim"}),
    47: ("tom_mid", {"strike_position": "rim"}),
    45: ("tom_mid", {}),
    43: ("tom_low", {"instrument_variant": "floor"}),
    58: ("tom_low", {"instrument_variant": "floor", "strike_position": "rim"}),  # TD-11: Tom3 Rim
    # Hi-hat (Roland TD-11: 42/22=Closed, 46/26=Open, 44=Pedal)
    42: ("hihat_closed", {}),
    22: ("hihat_closed", {"strike_position": "edge"}),
    44: ("hihat_pedal", {}),
    46: ("hihat_open", {}),
    26: ("hihat_open", {"strike_position": "edge"}),  # TD-11: HH Open Edge, NOT foot splash
    # Ride (Roland TD-11: 51=Bow, 59=Edge, 53=Bell)
    51: ("ride_bow", {}),
    59: ("ride_bow", {"strike_position": "edge"}),  # TD-11: Ride Edge, NOT bell
    53: ("ride_bell", {}),
    # Crash - TD-11 uses 49/55=Crash1, 57/52=Crash2 (ALL are crashes, not china/splash!)
    49: ("crash", {"instrument_variant": "crash1_bow"}),
    55: ("crash", {"instrument_variant": "crash1_edge"}),  # TD-11: Crash1 Edge, NOT splash!
    57: ("crash", {"instrument_variant": "crash2_bow"}),
    52: ("crash", {"instrument_variant": "crash2_edge"}),  # TD-11: Crash2 Edge, NOT china!
    # Aux percussion
    39: ("aux_percussion", {"instrument_variant": "clap"}),  # TD-11: Clap, NOT rimshot
    54: ("aux_percussion", {"instrument_variant": "tambourine"}),  # TD-11: Tambourine, NOT china!
    56: ("aux_percussion", {"instrument_variant": "cowbell"}),
    70: ("aux_percussion", {"instrument_variant": "maracas"}),
    64: ("aux_percussion", {"instrument_variant": "low_conga"}),
    75: ("aux_percussion", {"instrument_variant": "claves"}),
}
CYMBAL_MULTI_LABELS = {"crash"}
