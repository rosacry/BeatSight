...
# IMPORTANT: Groove MIDI Dataset uses Roland TD-11 mapping, NOT General MIDI!
# Reference: https://magenta.tensorflow.org/datasets/groove#drum-mapping
NOTE_MAP: Dict[int, Tuple[str, Dict[str, str]]] = {
    ...
    53: ("ride_bell", {}),
    # Crash - TD-11 uses 49/55=Crash1, 57/52=Crash2 (ALL are crashes, not china!)
...
# Groove/E-GMD only has crashes (no china/splash on Roland TD-11)
