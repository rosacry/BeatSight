...
# IMPORTANT: Slakh2100 uses General MIDI standard percussion mapping
# Reference: https://en.wikipedia.org/wiki/General_MIDI#Percussion
NOTE_MAP: Dict[int, Tuple[str, Dict[str, str]]] = {
    # Kick (GM: 35=Acoustic Bass Drum, 36=Bass Drum 1)
    35: ("kick", {"instrument_variant": "acoustic"}),
    36: ("kick", {}),
    # Snare (GM: 37=Side Stick, 38=Acoustic Snare, 40=Electric Snare)
    37: ("cross_stick", {}),
    38: ("snare", {}),
    40: ("snare", {"strike_position": "rimshot"}),
    # Toms (GM: 41=Low Floor, 43=High Floor, 45=Low, 47=Low-Mid, 48=Hi-Mid, 50=High)
    41: ("tom_low", {"instrument_variant": "floor_low"}),
    43: ("tom_low", {"instrument_variant": "floor"}),
    45: ("tom_low", {}),
    47: ("tom_mid", {}),
    48: ("tom_mid", {"instrument_variant": "high_mid"}),
    50: ("tom_high", {}),
    # Hi-hat (GM: 42=Closed, 44=Pedal, 46=Open)
    42: ("hihat_closed", {}),
    44: ("hihat_pedal", {}),
    46: ("hihat_open", {}),
    # Ride (GM: 51=Ride 1, 53=Ride Bell, 59=Ride 2)
    51: ("ride_bow", {}),
    53: ("ride_bell", {}),
    59: ("ride_bow", {"instrument_variant": "ride2"}),  # GM: Ride Cymbal 2, NOT bell!
    # Crash (GM: 49=Crash 1, 57=Crash 2)
    49: ("crash", {"instrument_variant": "crash1"}),
    57: ("crash", {"instrument_variant": "crash2"}),
    # Other cymbals (GM: 52=Chinese, 55=Splash)
    52: ("china", {}),
    55: ("splash", {}),
    # Aux percussion (GM: 39=Hand Clap, 54=Tambourine, 56=Cowbell, 58=Vibraslap)
    39: ("aux_percussion", {"instrument_variant": "clap"}),  # GM: Hand Clap, NOT rimshot!
    54: ("aux_percussion", {"instrument_variant": "tambourine"}),  # GM: Tambourine, NOT china!
