#!/bin/bash
# =============================================================================
# Quick Test V3 Extended - EXACT v3_minimal config, just more epochs
# =============================================================================
# v3_minimal WORKED (40.97% balanced acc, 21/21 classes)
# This is the EXACT same config, just with 10 epochs instead of 2.
# NO CHANGES to hyperparameters - we're testing if it scales.
# =============================================================================
...
RUN_DIR="${BEATSIGHT_REPO_ROOT}/ai-pipeline/training/runs/config_test_v3_extended_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$RUN_DIR"

echo "========================================================================"
echo "  V3 EXTENDED - Exact v3_minimal config with more epochs"
echo "========================================================================"
echo "Output: $RUN_DIR"
echo ""
echo "This is the EXACT working config from v3_minimal:"
echo "  - batch-size 64, grad-accum 1"
echo "  - lr 0.0001"
echo "  - train-fraction 0.01 (tiny but stratified with min 50/class)"
echo "  - UNIFORM sampling"
echo "  - drop-path 0.0, weight-decay 0.0"
echo "  - NO warmup, NO EMA"
echo ""
echo "ONLY CHANGE: 10 epochs instead of 2"
echo "========================================================================"
echo ""
...
echo ""
echo "========================================================================"
echo "  V3 Extended Complete"
echo "========================================================================"
echo ""
echo "If this works (no collapse through 10 epochs), we can gradually scale up:"
echo "  1. Increase train-fraction (more data)"
echo "  2. Increase batch size"
echo "  3. Add regularization (weight decay, drop path)"
echo "  4. Add EMA"
echo ""
echo "Change ONE thing at a time to find what causes collapse."
echo ""
