...
# ✅ Mid-epoch checkpoints every 10000 batches (~15-20 min intervals)
# ✅ Epoch checkpoints every epoch (for fine-grained recovery)
...
echo "║                                                                              ║"
echo "║  CHECKPOINTS: Every epoch + every 5000 batches (~10 min)                    ║"
