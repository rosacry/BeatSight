...
def get_drum_class_difficulty() -> Dict[str, float]:
    ...
    Note: Includes entries for post-processed output classes (snare_rimshot, etc.)
    even though the base model trains on 12 classes. Extra entries are harmless
    as lookups use .get() with defaults.
    """
    return {
