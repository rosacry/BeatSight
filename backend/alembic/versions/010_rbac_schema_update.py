...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("min_karma", sa.Integer, default=0, nullable=False, server_default="0"),
        sa.Column("requires_phone_verification", sa.Boolean, default=False, nullable=False, server_default="false"),
        sa.Column(
            "created_at",
