...
class AIJob(Base):
    ...
    state: Mapped[AIJobState] = mapped_column(SAEnum(AIJobState), default=AIJobState.QUEUED, nullable=False)
    priority: Mapped[AIJobPriority] = mapped_column(SAEnum(AIJobPriority), default=AIJobPriority.STANDARD, nullable=False)
