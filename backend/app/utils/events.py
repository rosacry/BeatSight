...
EventHandlerFunc = Union[Callable[[Any], None], Callable[[Any], Awaitable[None]]]
...
class Subscription:
    ...
    handler: EventHandlerFunc = field(repr=False)
    id: str = field(default_factory=lambda: str(uuid.uuid4()))
...
class EventBus:
    ...
    def subscribe(
        ...
        handler: Optional[EventHandlerFunc] = None,
        ...
        if handler is None:
            # Decorator usage
            def decorator(fn: EventHandlerFunc) -> EventHandlerFunc:
