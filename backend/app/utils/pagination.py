...
class PaginationMeta(BaseModel):
    ...
    has_prev: bool = Field(..., alias="hasPrev", description="Whether there's a previous page")
    next_cursor: str | None = Field(None, alias="nextCursor", description="Cursor for next page")
    prev_cursor: str | None = Field(None, alias="prevCursor", description="Cursor for previous page")
...
async def paginate_query_cursor(
    ...
    if items:
        ...
        if cursor_data:
            prev_cursor = encode_cursor(CursorData(
