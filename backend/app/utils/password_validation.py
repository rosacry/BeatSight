...
COMMON_PASSWORDS = {
    ...
    "shadow", "sunshine", "princess", "dragon", "monkey",
    "iloveyou", "trustno1", "1234567890", "football", "baseball",
    "password1!", "password123!", "qwertyuiop", "asdfghjkl",
    "beatsight", "beatsight123", "drums", "drummer", "music",
}
