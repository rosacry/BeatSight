...
class TestURLBuilder:
    ...
    def test_add_multiple_params(self):
        ...
        url = URLBuilder("https://example.com").params({"a": 1, "b": 2}).build()
        assert "a=1" in url
        assert "b=2" in url
...
class TestUtilityFunctions:
    ...
    def test_is_internal_url_same_domain(self):
        ...
        assert (
            is_internal_url("https://example.com/other", "https://example.com") is True
        )

    def test_is_internal_url_different_domain(self):
        """Test internal URL detection for different domain."""
        assert is_internal_url("https://other.com/path", "https://example.com") is False
