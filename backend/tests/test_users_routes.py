...
class TestUpdateCurrentUser:
    ...
    def test_update_display_name_success(self):
        ...
        _original_name = mock_user.display_name
        ...
        try:
            client = TestClient(app)
            response = client.patch("/api/users/me", json={"display_name": "New Name"})
...
class TestChangePassword:
    ...
    def test_change_password_success(self):
        ...
        hashed = bcrypt.hashpw(
            current_password.encode("utf-8"), bcrypt.gensalt()
        ).decode("utf-8")
    ...
    def test_change_password_unauthorized(self):
        ...
        response = client.post(
            "/api/users/me/password",
            json={"current_password": "current", "new_password": "new_password_123"},
        )
...
class TestDeleteAccount:
    ...
    def test_delete_account_wrong_password(self):
        ...
        try:
            ...
            response = client.request(
                "DELETE",
                "/api/users/me",
                json={"confirmation": "DELETE", "password": "wrong_password"},
            )
    ...
    def test_delete_account_missing_confirmation(self):
        ...
        try:
            client = TestClient(app)
            response = client.request(
                "DELETE", "/api/users/me", json={"password": "password123"}
            )
