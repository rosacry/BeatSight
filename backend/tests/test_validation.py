...
class TestValidateEmail:
    ...
    def test_non_disposable_with_block(self):
        ...
        assert validate_email("user@gmail.com", allow_disposable=False) is True
...
class TestFilenameValidation:
    ...
    def test_allowed_extensions(self):
        ...
        assert (
            validate_filename("image.jpg", allowed_extensions={".jpg", ".png"}) is True
        )
        assert (
            validate_filename("script.exe", allowed_extensions={".jpg", ".png"})
            is False
        )
