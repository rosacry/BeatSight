...
public class ManuscriptPlaybackHighlighterTests
{
    ...
    public void CursorTrailWidthUsesFallbackBandWhenTimelineUnavailable()
    {
        ...
        Assert.InRange(width, 69f, 71f);
    }

    [Theory]
    [InlineData(1000f, 4000.0, 120.0, 500.0, 72.0)] // max-clamped center case
    [InlineData(1000f, 2000.0, 120.0, 500.0, 72.0)] // max clamp case
    [InlineData(1000f, 10000.0, 120.0, 200.0, 50.0)] // adaptive lookahead with lower floor
