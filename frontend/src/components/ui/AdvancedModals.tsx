...
const sheetStyles = cva(
    'fixed z-50 bg-dark-400 border-white/10/50 shadow-2xl outline-none overflow-auto',
    {
        variants: {
            side: {
        ...
        <>
            ...
            >
                ...
                {(title || showCloseButton) && (
                    <div className="flex items-center justify-between p-4 border-b border-white/10/50">
                        <div>
                            {title && (
        ...
        <>
            ...
            <div
                ...
                className={clsx(
                    ...
                    'w-full max-w-xl bg-dark-400 border border-white/10/50 rounded-xl shadow-2xl overflow-hidden',
            ...
            >
                {/* Search input */}
                <div className="flex items-center gap-3 p-4 border-b border-white/10/50">
                    ...
                    <input
                        ...
                        autoFocus
                    />
                    <kbd className="px-2 py-1 text-xs text-gray-400 bg-dark-300/50 rounded">ESC</kbd>
                </div>
                                ...
                                {groupItems.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={clsx(
                                                ...
                                                isSelected
                                                    ...
                                                    : 'text-gray-300 hover:bg-dark-300/50',
                                        ...
                                        >
                                            ...
                                            {item.shortcut && (
                                                <kbd className="flex-shrink-0 px-2 py-1 text-xs text-gray-400 bg-dark-300/50 rounded">
                                                    {item.shortcut}
                                                </kbd>
                                            )}
                                        </button>
                ...
                {/* Footer */}
                <div className="flex items-center justify-between px-4 py-2 border-t border-white/10/50 text-xs text-gray-500">
                    <div className="flex items-center gap-2">
                        <span className="flex items-center gap-1">
                            <kbd className="px-1.5 py-0.5 bg-dark-300/50 rounded">↑</kbd>
                            <kbd className="px-1.5 py-0.5 bg-dark-300/50 rounded">↓</kbd>
                            navigate
                        </span>
                        <span className="flex items-center gap-1">
                    ...
                    <span className="flex items-center gap-1">
                        <kbd className="px-1.5 py-0.5 bg-dark-300/50 rounded">esc</kbd>
                        close
                    </span>
                </div>
            </div>
    ...
    return createPortal(
        <>
            ...
            <div
                ...
                data-state="open"
                className={clsx(
                    'fixed inset-x-0 bottom-0 z-50 bg-dark-400 border-t border-white/10/50 rounded-t-2xl max-h-[85vh] overflow-auto',
            ...
            >
                ...
                {/* Header */}
                {title && (
                    <div className="flex items-center justify-between px-4 pb-3 border-b border-white/10/50">
                        <div>
                            <h2 id={titleId} className="text-lg font-semibold text-white">
                                {title}
                            </h2>
...
export function FullscreenOverlay({
    ...
    return createPortal(
        <div
            ...
            aria-modal="true"
            className={clsx(
                'fixed inset-0 z-50 bg-dark-500',
        ...
        >
            ...
            {showCloseButton && (
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 z-10 p-3 rounded-lg text-gray-400 hover:text-white hover:bg-dark-400 transition-colors"
                    aria-label={ARIA_LABELS.CLOSE}
                >
