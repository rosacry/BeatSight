...
export function JobQueuePage() {
    ...
    return (
        <PageContentWrapper className="max-w-6xl mx-auto px-4 py-6 sm:py-8 space-y-6" isLoading={isLoading}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
                        ...
                        <div className="lg:col-span-3 space-y-4">
                            ...
                            {isLoading ? (
                                ...
                                <StaggerPageContent className="space-y-4" animationKey={filter}>
