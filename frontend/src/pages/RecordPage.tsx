    ...
    if (permissionState === 'prompt' || permissionState === 'checking') {
        return (
            <div className="max-w-2xl mx-auto px-4 py-6">
                ...
                <div className="bg-dark-400 rounded-xl border border-white/10 p-8">
                    <div className="text-center">
                        <div className="w-20 h-20 mx-auto mb-6 relative">
                            <div className="absolute inset-0 bg-primary-500/20 rounded-full animate-pulse" />
                            <div className="relative w-20 h-20 bg-dark-300 rounded-full flex items-center justify-center border-2 border-primary-500/50">
